	...
	<div class="modal fade" id="modal-task">
		<div class="modal-dialog">
			<div class="modal-content">
				<form action="scripts.php" method="POST" action="scripts.php" id="form-task">
					...
					<div class="modal-body">
							...
							<div class="mb-3">
								...
								<div class="ms-3">
									<div class="form-check mb-1">
										<input class="form-check-input" name="task_type" type="radio" value="1" id="task_type_feature"/>
										<label class="form-check-label" for="task_type_feature">Feature</label>
									</div>
									<div class="form-check">
										<input class="form-check-input" name="task_type" type="radio" value="2" id="task_type_bug"/>
										<label class="form-check-label" for="task_type_bug">Bug</label>
									</div>
								</div>
							...
							<div class="mb-3">
								...
								<select class="form-select" name="priority" id="task_priority">
							...
							<div class="mb-3">
								...
								<select class="form-select" name="status" id="task_statut">
									<option value="">Please select</option>
							...
							<div class="mb-3">
								...
								<input type="date" class="form-control" name="date" id="task_date"/>
							</div>
							<div class="mb-0">
